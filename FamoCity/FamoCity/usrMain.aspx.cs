...
namespace FamoCity
{
    public partial class usrMain : System.Web.UI.Page
    {

        /*
         * this page will recive this paramertes:
         * 
         * ty => type of page (user=1, shop=50) see more about object code in FamoBlock.enmObjectCode
         * uid => user id
         * pg => page number it's. see more about page numbers in ClassMain.PageName
         */
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string logo2="";
            logo2 = "<img src='/newfiles/images/famocity_logo_m_ar.png' alt='Logo' title='FamoCity' />";
            if (Passport != null)
            {
                famologo.Text = "<a class='logoPc' href='" + ClassMain.WebHosting + "person/" + Passport.UserID + "/Arena" + "'>" + logo + "</a>";
                //famologo.Text += "<a class='logoTab' href='" + ClassMain.WebHosting + "person/" + Passport.UserID + "/Arena" + "'>" + logo2 + "</a>";
            }
            else
                famologo.Text = logo;
            ...
            if (!IsPostBack)
            {
                ...
                // Methods.GetCountOfRequest(Passport.UserID).ToString();
                //lblCount.Text = Methods.GetCountOfRequest(Passport.UserID).ToString();
        ...
        private void BindReqFriends()
        {
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                try
                {
                    ...
                    dr["UserName"] = "<a href='" + ClassMain.WebHosting + "person/" + requser.ID + "/Arena" + "' >" + dtb.Rows[0]["firstname"].ToString() + " " + dtb.Rows[0]["lastname"].ToString() + "</a>";
